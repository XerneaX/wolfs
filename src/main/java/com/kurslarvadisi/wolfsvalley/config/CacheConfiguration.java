package com.kurslarvadisi.wolfsvalley.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.kurslarvadisi.wolfsvalley.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.kurslarvadisi.wolfsvalley.repository.UserRepository.USERS_BY_EMAIL_CACHE);
