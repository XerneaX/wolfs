...
class CourseResourceIT {
    ...
    public static Course createEntity(EntityManager em) {
        Course course = new Course().name(DEFAULT_NAME).phoneNumber(DEFAULT_PHONE_NUMBER).email(DEFAULT_EMAIL);
        return course;
    }
    ...
    public static Course createUpdatedEntity(EntityManager em) {
        Course course = new Course().name(UPDATED_NAME).phoneNumber(UPDATED_PHONE_NUMBER).email(UPDATED_EMAIL);
        return course;
    }
    ...
    void createCourse() throws Exception {
        ...
        assertThat(testCourse.getPhoneNumber()).isEqualTo(DEFAULT_PHONE_NUMBER);
        assertThat(testCourse.getEmail()).isEqualTo(DEFAULT_EMAIL);
    }
    ...
    void putNewCourse() throws Exception {
        ...
        updatedCourse.name(UPDATED_NAME).phoneNumber(UPDATED_PHONE_NUMBER).email(UPDATED_EMAIL);
        ...
        assertThat(testCourse.getPhoneNumber()).isEqualTo(UPDATED_PHONE_NUMBER);
        assertThat(testCourse.getEmail()).isEqualTo(UPDATED_EMAIL);
    }
    ...
    void partialUpdateCourseWithPatch() throws Exception {
        ...
        partialUpdatedCourse.email(UPDATED_EMAIL);
    ...
    void fullUpdateCourseWithPatch() throws Exception {
        ...
        partialUpdatedCourse.name(UPDATED_NAME).phoneNumber(UPDATED_PHONE_NUMBER).email(UPDATED_EMAIL);
