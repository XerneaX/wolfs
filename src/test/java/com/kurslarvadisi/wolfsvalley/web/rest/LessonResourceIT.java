...
import static com.kurslarvadisi.wolfsvalley.web.rest.TestUtil.sameNumber;
...
class LessonResourceIT {
    ...
    public static Lesson createEntity(EntityManager em) {
        Lesson lesson = new Lesson().name(DEFAULT_NAME).desc(DEFAULT_DESC).price(DEFAULT_PRICE);
        return lesson;
    }
    ...
    public static Lesson createUpdatedEntity(EntityManager em) {
        Lesson lesson = new Lesson().name(UPDATED_NAME).desc(UPDATED_DESC).price(UPDATED_PRICE);
        return lesson;
    }
    ...
    void createLesson() throws Exception {
        ...
        assertThat(testLesson.getDesc()).isEqualTo(DEFAULT_DESC);
    ...
    void putNewLesson() throws Exception {
        ...
        updatedLesson.name(UPDATED_NAME).desc(UPDATED_DESC).price(UPDATED_PRICE);
        ...
        assertThat(testLesson.getDesc()).isEqualTo(UPDATED_DESC);
        assertThat(testLesson.getPrice()).isEqualTo(UPDATED_PRICE);
    }
    ...
    void fullUpdateLessonWithPatch() throws Exception {
        ...
        partialUpdatedLesson.name(UPDATED_NAME).desc(UPDATED_DESC).price(UPDATED_PRICE);
